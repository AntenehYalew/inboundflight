                                                ...
                                                if (flightDate === today && flightDestination === user_station){
                                                    ...
                                                    if(status === "Scheduled " || status === "Canceled " || status === "Unknown "){
                                                        ...
                                                        if(dataInfo["children"][8]["attribs"]["data-timestamp"]=== ""){
                                                            ...
                                                            statusTime = ((new Date((dataInfo["children"][11]["attribs"]["data-timestamp"]) *1000)).toLocaleTimeString('en-US',{hour12:false})).slice(0,5);
                                                            readableStatus="ETA"
                                                        }
                                                        ...
                                                        let retrivedFlight = {
                                                            ...
                                                            "STA":STA,
                                                            "STD":((new Date((dataInfo["children"][7]["attribs"]["data-timestamp"]) *1000)).toLocaleTimeString('en-US',options)).slice(0,5),
                                                            "ATD":ATD,
                                                            "OSTA":OSTA,
